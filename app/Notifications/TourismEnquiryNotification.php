...
class TourismEnquiryNotification extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->subject('Tourism Package Enquiry for ' . $this->details['tourism-type'] . ' from ' . $this->details['name'])
            ...
            ->line('Tourism Type: ' . $this->details['tourism-type'])
