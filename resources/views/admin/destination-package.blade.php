            ...
            <div class="modal fade" id="PackageAddModal" tabindex="-1" aria-labelledby="PackageAddModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('add.destination.package', ['id' => $model->id]) }}" method="post" id="add-package-form" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-body">
                            ...
                            <div class="modal fade" id="PackageEditModal_{{ $package->id }}" tabindex="-1" aria-labelledby="PackageEditModal_{{ $package->id }}Label" aria-hidden="true">
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('edit.destination.package', ['destinationId' => $model->id, 'packageId' => $package->id]) }}" method="post" id="edit-package-form" enctype="multipart/form-data">
                                            @csrf
                                            <div class="modal-body">
                                                <label for="title">Title</label>
                            ...
                            <div class="modal fade" id="PackageDeleteModal_{{ $package->id }}" tabindex="-1" aria-labelledby="PackageDeleteModal_{{ $package->id }}Label" aria-hidden="true">
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('delete.destination.package', ['destinationId' => $model->id, 'packageId' => $package->id]) }}" method="post" id="delete-package-form" enctype="multipart/form-data">
                                            @method ('DELETE')
                                            @csrf
                                            <div class="modal-body">
