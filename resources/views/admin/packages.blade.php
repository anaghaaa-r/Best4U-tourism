...
<body>
    ...
    <section id="hero" style="padding-bottom: 100px;">
        ...
        <div class="main_body">
                    ...
                    <div class="tab-container">
                        <ul class="nav nav-tabs" id="myTab" style="margin-left: 10px">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" data-tab-id="destinations" id="destinations-tab" data-bs-toggle="tab" data-bs-target="#destinations" type="button" role="tab" aria-selected="true">
                                    <b>DESTINATIONS</b>
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" data-tab-id="tourism" id="tourism-tab" data-bs-toggle="tab" data-bs-target="#tourism" type="button" role="tab" aria-selected="false">
                                    <b>TOURISM</b>
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" data-tab-id="dubai-special" id="dubai-special-tab" data-bs-toggle="tab" data-bs-target="#dubai-special" type="button" role="tab" aria-selected="false">
                                    <b>DUBAI SPECIAL PACKAGES</b>
                                </button>
                            </li>
            ...
            <div class="tab-content" style="margin-left: 10px; margin-top: 50px">
                ...
                <!-- DESTINATIONS -->
                <div class="tab-pane fade show active" role="tabpanel" id="destinations" aria-labelledby="destinations-tab">
                    <h4>DESTINATIONS</h4>

                    <div class="row">
                        <div class="col-4">
                            <form id="add-destination-form" class="add-destination-form" action="{{ route('add.destination') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <div class="modal fade" id="DestinationEditModal_{{ $destination->id }}" tabindex="-1" aria-labelledby="DestinationEditModal_{{ $destination->id }}Label" aria-hidden="true">
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('edit.destination', ['id' => $destination->id]) }}" method="post" class="edit-destination-form" id="edit-destination-form" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="modal-body">
                                                            <label for="title">Destination Title</label>
                                        ...
                                        <div class="modal fade" id="DestinationDeleteModal_{{ $destination->id }}" tabindex="-1" aria-labelledby="DestinationDeleteModal_{{ $destination->id }}Label" aria-hidden="true">
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('delete.destination', ['id' => $destination->id]) }}" method="post" class="delete-destination-form" id="delete-destination-form" enctype="multipart/form-data">
                                                        @method ('DELETE')
                                                        @csrf
                                                        <div class="modal-body">
                ...
                <!-- TOURISM -->
                <div class="tab-pane fade" role="tabpanel" id="tourism" aria-labelledby="tourism-tab">
                    <h4>TOURISM</h4>
                    <div class="row">
                        <div class="col-4">
                            <form id="add-tourism-form" class="add-tourism-form" action="{{ route('add.tourism') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <div class="modal fade" id="TourismEditModal_{{ $tourism->id }}" tabindex="-1" aria-labelledby="TourismEditModal_{{ $tourism->id }}Label" aria-hidden="true">
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('edit.tourism', ['id' => $tourism->id]) }}" method="post" class="edit-tourism-form" id="edit-tourism-form" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="modal-body">
                                                            <label for="title">Tourism Title</label>
                                        ...
                                        <div class="modal fade" id="TourismDeleteModal_{{ $tourism->id }}" tabindex="-1" aria-labelledby="TourismDeleteModal_{{ $tourism->id }}Label" aria-hidden="true">
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('delete.tourism', ['id' => $tourism->id]) }}" method="post" class="delete-tourism-form" id="delete-tourism-form" enctype="multipart/form-data">
                                                        @method ('DELETE')
                                                        @csrf
                                                        <div class="modal-body">
                ...
                <div class="tab-pane fade" role="tabpanel" id="dubai-special" aria-labelledby="dubai-special-tab">
                    <h4>DUBAI SPECIAL PACKAGE</h4>
                    <div>
                        <!-- Add Modal -->
                        ...
                        <div class="modal fade" id="PackageAddModal" tabindex="-1" aria-labelledby="PackageAddModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('add.dubaispecialpackage') }}" method="post" class="add-package-form" id="add-package-form" enctype="multipart/form-data">
                                        @csrf
                                        <div class="modal-body">
                                            ...
                                            <p cclass="mb-2" style="font-size: 13px; color: brown;">*thumbnail dimension should be 270px X 301px</p>
                                        ...
                                        <div class="modal fade" id="PackageEditModal_{{ $package->id }}" tabindex="-1" aria-labelledby="PackageEditModal_{{ $package->id }}Label" aria-hidden="true">
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('edit.dubaispecialpackage', ['id' => $package->id]) }}" method="post" class="edit-package-form" id="edit-package-form" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="modal-body">
                                                            <label for="title">Title</label>
                                                            ...
                                                            <label for="thumbnail">Thumbnail Image</label>
                                                            <input type="file" name="thumbnail" id="edit-thumbnail" class="form-control mb-2">
                                                            <p id="edit-dimension-error" style="font-size: 13px; color: brown;"></p>
                                                            <p class="mb-2" style="font-size: 13px; color: brown;">*thumbnail dimension should be 270px X 301px</p>
                                        ...
                                        <div class="modal fade" id="PackageDeleteModal_{{ $package->id }}" tabindex="-1" aria-labelledby="PackageDeleteModal_{{ $package->id }}Label" aria-hidden="true">
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('delete.dubaispecialpackage', ['id' => $package->id]) }}" class="delete-package-form" method="post" id="delete-package-form" enctype="multipart/form-data">
                                                        @method ('DELETE')
                                                        @csrf
                                                        <div class="modal-body">
    ...
    <script src="{{ asset('admin/js/custom-all-package.js') }}"></script>
