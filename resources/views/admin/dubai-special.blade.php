    ...
    <header id="header" class="d-flex flex-column justify-content-center">
        ...
        <nav id="navbar" class="navbar nav-menu">
            <ul>
                ...
                <li><a href="{{ url('/admin/dubaispecialpackages') }}" class="nav-link scrollto active"><i class="bx bxs-file-archive"></i> <span>DUBAI SPECIAL PACKAGES</span></a></li>
            ...
            <div class="modal fade" id="PackageAddModal" tabindex="-1" aria-labelledby="PackageAddModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('add.dubaispecialpackage') }}" method="post" id="add-package-form" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-body">
                            ...
                            <div class="modal fade" id="PackageEditModal_{{ $package->id }}" tabindex="-1" aria-labelledby="PackageEditModal_{{ $package->id }}Label" aria-hidden="true">
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('edit.dubaispecialpackage', ['id' => $package->id]) }}" method="post" id="edit-package-form" enctype="multipart/form-data">
                                            @csrf
                                            <div class="modal-body">
                                                <label for="title">Title</label>
                            ...
                            <div class="modal fade" id="PackageDeleteModal_{{ $package->id }}" tabindex="-1" aria-labelledby="PackageDeleteModal_{{ $package->id }}Label" aria-hidden="true">
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('delete.dubaispecialpackage', ['id' => $package->id]) }}" method="post" id="delete-package-form" enctype="multipart/form-data">
                                            @method ('DELETE')
                                            @csrf
                                            <div class="modal-body">
